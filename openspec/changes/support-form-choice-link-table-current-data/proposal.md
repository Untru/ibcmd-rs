...
источников. `AdditionalColumns` является supplemental-источником: он заполняет
только отсутствующий route и не стирает уже доказанный direct child-item
route. Неоднозначный supplemental route не добавляется.
