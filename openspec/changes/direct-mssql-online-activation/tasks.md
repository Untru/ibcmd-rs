...
- [ ] 6. Add `mssql-apply-source-change` with `online`/`exclusive`, `--dry-run`, explicit trust/auth/safety flags, stable JSON reporting, recovery token, and unchanged no-op behavior.
