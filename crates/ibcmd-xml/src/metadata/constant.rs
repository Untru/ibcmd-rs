...
pub fn bundled_metadata_registry() -> MetadataRegistry {
    ...
    super::business_objects::register_document_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::hierarchical_objects::register_subsystem_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::hierarchical_objects::register_exchange_plan_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::hierarchical_objects::register_business_process_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    ...
    super::utility_objects::register_settings_storage_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::common_objects::register_common_module_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::common_objects::register_common_command_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::common_objects::register_command_group_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::common_objects::register_common_picture_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    ...
    super::services::register_ws_reference_codec(&mut registry)
        .expect("bundled families are unique and bounded");
    super::services::register_integration_service_codec(&mut registry)
        .expect("bundled families are unique and bounded");
