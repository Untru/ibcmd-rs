...
pub use metadata::{
    CharacteristicsXmlError, MetadataDecodeError, MetadataEncodeError, MetadataEnvelope,
    MetadataFamilyCodec, MetadataOrderError, MetadataRegistry, MetadataRegistryError,
    bundled_metadata_registry, decode_metadata_envelope, decode_metadata_envelope_with_dialect,
